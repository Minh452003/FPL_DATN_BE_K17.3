...
const sendVerificationEmail = async (userId) => {
    ...
    const details = {
        ...
        subject: "📲 Đăng kí thành công nội thất Casa",
        html:
            `
            <h1>Chúc mừng bạn đến với Casa ^^</h1>
            ...
            <img src="https://www.quadernionline.it/wp-content/uploads/2021/07/siti-web-parma.jpg" alt="Casa Logo">
            <p>Chúc bạn có một trải nghiệm tuyệt vời với phiên bản hoàn toàn mới này!</p>
            <p>Mọi góp ý và phản hồi bạn liên hệ dưới đây : </p>
            <p>Gmail: duongthph21290@fpt.edu.vn</p>
